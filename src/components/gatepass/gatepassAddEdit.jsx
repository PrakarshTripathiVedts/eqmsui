...
const GatePassAddEdit = ({
    ...
    } = useGatepassAttachment();

    const filSize = Number(
        localStorage.getItem("filSize") || 25 * 1024 * 1024
    );
    ...
    // =========================
    // Load Gatepass for Edit
    // =========================
    useEffect(() => {
        if (mode === "edit" && gatepassId) {
            loadGatepassById(gatepassId);
        }
    }, [gatepassId, mode]);
    ...
    const validationSchema = Yup.object().shape({
        ...
        gatepassNo: Yup.string()
            .required(
                "Gatepass No is required"
            ),

        gatepassDate: Yup.string()
            .required(
                "Gatepass Date is required"
            ),
        ...
        probableReturnDate: Yup.string()
            ...
            .when("category", {
                is: (cat) =>
                    SHOW_RETURN_DATE_FOR.includes(cat),

                then: (schema) =>
                    schema
                        .required(
                            "Probable Return Date is required"
                        )
                        .test(
                            "after-gatepass-date",
                            "Must be on or after Gatepass Date",
                            function (value) {
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            ...
            if (mode === "add") {
                ...
                const exists =
                    await checkGatepassNoExists(
                        values.gatepassNo.trim()
                    );

                if (exists) {

                    setGatepassNoError(
                        `Gatepass No "${values.gatepassNo}" already exists.`
                    );
                ...
                if (
                    response?.gatepassId > 0
                ) {

                    showAlert(
                        "Success",
                        "Gatepass added successfully",
                        "success"
                    );
                    ...
                    showAlert(
                        "Error",
                        "Failed to save Gatepass. Please try again.",
                        "error"
                    );
                }
            ...
            // =========================
                ...
                if (
                    ...
                    showAlert(
                        "Error",
                        "Failed to update Gatepass. Please try again.",
                        "error"
                    );
                }
            }
                ...
                >
                    ...
                    >
                        ...
                        {({
                            ...
                            const showProbableReturn =
                                SHOW_RETURN_DATE_FOR.includes(
                                    values.category
                                );
                                                            ...
                                                            onBlur={async (
                                                                ...
                                                                try {
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        setGatepassNoError(
                                                                            `Gatepass No "${val}" already exists.`
                                                                        );
                                                                    }
                                        ...
                                        <div className="col-md-4">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <DatePicker
                                                    ...
                                                    placeholderText="Select Gatepass Date"
                                                        ...
                                                        projectList.map(
                                                            (p) => ({
                                                                value:
                                                                    p.projectId,
                                                                label:
                                                                    `${p.projectCode} - ${p.projectShortName}`,
                                                            })
                                                        )
                                                    }
                                                    value={(() => {
                                                        ...
                                                        return matched
                                                            ? {
                                                                value:
                                                                    matched.projectId,
                                                                label:
                                                                    `${matched.projectCode} - ${matched.projectShortName}`
                                                            }
                                                            : null;
                                            ...
                                            <div className="col-md-4">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <DatePicker
                                                        ...
                                                        className="form-control mb-2"
                                                        placeholderText="Select Probable Return Date"
                                                        dateFormat="dd-MM-yyyy"
                                                        showYearDropdown
                                                        showMonthDropdown
                                                        dropdownMode="select"
                                            ...
                                            <div className="form-group">
                                                ...
                                                {mode === "edit" &&
                                                    existingFilename && (
                                                        ...
                                                        <small
                                                            className="text-muted text-start d-block"
                                                        >
