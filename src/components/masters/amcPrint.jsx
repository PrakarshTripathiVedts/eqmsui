...
export const generateAmcPdf = (data, equipment) => {
    const docDefinition = {
        pageSize: "A4",
        ...
        content: [
...

            {
                table: {
                    ...
                    body: [
                        [
                            { text: "AMC Agency", bold: true },
                            data.amcAgency || "-",
                        ],
                        [
                            { text: "AMC Start Date", bold: true },
                            formatDate(data.amcStartDate),
                        ],
                        [
                            { text: "AMC End Date", bold: true },
                            formatDate(data.amcEndDate),
                        ],
                    ],
